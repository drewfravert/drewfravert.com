defmodule PortfolioWeb do
  @moduledoc """
  The entrypoint for defining your web interface, such as controllers, views, channels and
  so on.
  ...
  The definitions below will be executed for every view, controller, etc, so keep them short
