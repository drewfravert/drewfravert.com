defmodule PortfolioWeb.Endpoint do
  ...
  # The session will be stored in the cookie and signed, this means its contents can be read
  # but not tampered with. Set :encryption_salt if you would also like to encrypt it.
  @session_options [
    store: :cookie,
    key: "_portfolio_key",
    signing_salt: "qpSGq9r3"
  ]
  ...
  #
  # You should set gzip to true if you are running phx.digest when deploying your static
  # files in production.
  plug Plug.Static,
    at: "/",
    from: :portfolio,
