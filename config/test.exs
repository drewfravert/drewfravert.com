...
# partitioning in CI environment. Run `mix help test` for more information.
...
# We don't run a server during test. If one is required, you can enable the server option
# below.
